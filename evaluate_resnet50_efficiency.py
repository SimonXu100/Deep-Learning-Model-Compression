from prune_structured_resnet50 import *
...
if __name__ == "__main__":
    ...
    for frac in FRAC_LIST:
        ...
        print("")
        print("==========================================================")
        PRUNED_MODEL_PATH = "resnet50_chkpt/model_conv_frac_%.2f.pth"%frac
        ...
        conv_modules = get_conv_modules(model_pruned)
        ...
        num_params = print_mask_sum(model_pruned)
        ...
        np.savetxt("performance/resnet50_structured_%.2f_efficiency.txt"%frac, inference_time_matrix)


    np.savetxt("performance/resnet50_structured_num_params.txt", num_params_list)