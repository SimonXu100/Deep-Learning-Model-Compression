from prune_structured_resnet18 import *
...
if __name__ == "__main__":
    ...
    for frac in FRAC_LIST:
        ...
        print("")
        print("==========================================================")
        PRUNED_MODEL_PATH = "resnet18_chkpt/model_conv_frac_%.2f.pth"%frac
        ...
        np.savetxt("performance/resnet18_structured_%.2f_efficiency.txt"%frac, inference_time_matrix)


    np.savetxt("performance/resnet18_structured_num_params.txt", num_params_list)